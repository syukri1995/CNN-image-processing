...
def show_classifier():
    ...
    with col1:
        ...
        uploaded_file = st.file_uploader(
            "Choose a food image...",
            type=["jpg", "jpeg", "png"],
            help="Upload a JPG or PNG image to classify it into one of the 5 food categories."
        )
...
def show_gallery():
        ...
        for i, img_path in enumerate(image_paths):
            with cols[i % 4]:
                ...
                with st.container():
                    ...
                    if st.button("🔍 View", key=f"btn_{i}", use_container_width=True, help="View in fullscreen"):
    ...
    # -----------------------------
        ...
        if not st.session_state.current_image_list:
            ...
            if st.button("Back to Gallery", help="Return to grid view"):
                st.session_state.view_mode = 'grid'
                st.rerun()
            return
        ...
        with col_next:
            ...
            if idx < total - 1:
                ...
                st.button("▶️", disabled=True, key="next_btn_disabled", help="No next image")
