...
## 2024-05-23 - Empty States in Streamlit
**Learning:** Streamlit lacks native empty state components, leading to "blank" or purely textual warning UIs.
**Action:** Use `st.markdown` with centered div, subtle background, and icons to guide users during empty/loading states.
