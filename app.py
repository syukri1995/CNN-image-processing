...
def show_classifier():
    ...
    with col2:
        ...
        if uploaded_file:
            ...
            st.markdown("""
            <div style="text-align: center; padding: 40px; background-color: #f0f2f6; border-radius: 10px; border: 2px dashed #ccc;">
                <h3 style="color: #666;">Waiting for Image</h3>
                <p style="color: #888;">Upload a food image to see the AI prediction here.</p>
            </div>
            """, unsafe_allow_html=True)
        ...
        if not image_paths:
            st.markdown("""
                <div style="text-align: center; padding: 50px; color: #666;">
                    ...
                    <p>Try selecting a different category or increasing the limit.</p>
                </div>
            """, unsafe_allow_html=True)
            return
    ...
    # -----------------------------
        ...
        with col_prev:
            ...
            if idx > 0:
                ...
                st.button("◀️", disabled=True, key="prev_btn_disabled")
        ...
        with col_next:
            ...
            if idx < total - 1:
                ...
                st.button("▶️", disabled=True, key="next_btn_disabled")
